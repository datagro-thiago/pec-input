 ...
 */
class Src_Infraestrutura_Kernel_KernelDevDebugContainer extends Container
{
    protected $targetDir;
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'Src\\Infraestrutura\\Web\\Controladores\\ControladorNegocio' => 'getControladorNegocioService',
            'Src\\Infraestrutura\\Web\\Servicos\\Negocio\\ProcessarNegocio' => 'getProcessarNegocioService',
            'Src\\Infraestrutura\\Web\\Servicos\\Handler\\ProcessarNegocioHandler' => 'getProcessarNegocioHandlerService',
        ...
        $this->aliases = [
            'Src\\Infraestrutura\\Kernel\\Kernel' => 'kernel',
        ];
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $a->allowControllers(['Src\\Infraestrutura\\Kernel\\Kernel']);
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'debug.container.dump' => ($container->targetDir.''.'/Src_Infraestrutura_Kernel_KernelDevDebugContainer.xml'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'Src_Infraestrutura_Kernel_KernelDevDebugContainer',
